...
## prediction based on the model using partial training data(dataset = valid)
...
The classification tree model did not produce very accurate predictions.  None of the "D classe" were predicted.
